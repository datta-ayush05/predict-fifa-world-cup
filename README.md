...
<img width="1453" height="862" alt="Screenshot (10)" src="https://github.com/user-attachments/assets/2f5483da-ae33-427a-8308-e90bf2f97d1d" />
...
The project includes a fully serverless **React Frontend**. Using the precomputed expected goals (xG) matrix generated by the GNN model, the dashboard can calculate real-time Win/Draw/Loss Poisson probabilities for **any two teams**, not just those in the same group!

<img width="1890" height="901" alt="Screenshot (9)" src="https://github.com/user-attachments/assets/8674a582-a498-49b5-8e7e-ba6740b4c149" /> 

<img width="1895" height="901" alt="Screenshot (8)" src="https://github.com/user-attachments/assets/f3263980-31b4-4a91-b0a7-9b8e5a0e42c6" />
...
To publish the dashboard live for free:
1. Generate static files: `npm run build` inside `src/web/frontend`
2. Drag and drop the newly created `dist/` folder into Netlify Drop.
